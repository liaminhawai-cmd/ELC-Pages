...
(function () {
  ...
  /* ---------- styles ---------- */
  var CSS = "" +
  ".sv-word{border-bottom:2px dotted var(--accent,#2563eb);cursor:pointer;border-radius:2px}" +
  ".sv-word:hover,.sv-word:focus-visible{background:var(--accent-soft,#dbeafe)}" +
  ...
  ".sv-book{position:fixed;right:14px;bottom:14px;z-index:9000;width:52px;height:52px;border-radius:50%;" +
    "border:1px solid var(--line,#e3e8f2);background:var(--card,#fff);box-shadow:0 4px 14px rgba(16,24,40,.18);" +
    "font-size:24px;cursor:pointer;display:flex;align-items:center;justify-content:center}" +
  ".sv-book .sv-count{position:absolute;top:-6px;right:-6px;background:var(--accent,#2563eb);color:#fff;" +
  ...
  "@keyframes svglow{from{box-shadow:0 0 0 0 rgba(37,99,235,.55)}to{box-shadow:0 0 0 12px rgba(37,99,235,0)}}" +
  ".sv-panel{position:fixed;top:0;right:0;bottom:0;width:min(460px,100%);z-index:9001;background:var(--card,#fff);" +
    "color:var(--ink,#1c2333);border-left:1px solid var(--line,#e3e8f2);box-shadow:-8px 0 30px rgba(16,24,40,.18);" +
    "transform:translateX(105%);transition:transform .22s ease;display:flex;flex-direction:column}" +
  ".sv-panel.sv-open{transform:none}" +
  "@media(max-width:720px){.sv-panel{top:auto;left:0;width:100%;max-height:82vh;border-left:0;border-top:1px solid var(--line,#e3e8f2);" +
    "border-radius:16px 16px 0 0;transform:translateY(105%)}.sv-panel.sv-open{transform:none}}" +
  ".sv-head{display:flex;align-items:center;gap:8px;padding:12px 16px;border-bottom:1px solid var(--line,#e3e8f2)}" +
  ".sv-head h2{font-size:1.25rem;margin:0;flex:1;font-family:Georgia,'Times New Roman',serif}" +
  ".sv-x{border:0;background:none;font-size:22px;cursor:pointer;color:var(--muted,#5b6478);padding:4px 8px}" +
  ...
  ".sv-chip{border-radius:999px;padding:4px 12px;font-size:.85rem;font-weight:600;border:1px solid var(--line,#e3e8f2)}" +
  ...
  ".sv-tr{background:var(--accent-soft,#dbeafe);border-radius:10px;padding:8px 12px;margin:10px 0}" +
  ".sv-tr select{margin-left:6px;font:inherit;border-radius:8px;border:1px solid var(--line,#e3e8f2);padding:2px 6px;background:var(--card,#fff);color:var(--ink,#1c2333)}" +
  ".sv-tr .sv-trword{font-size:1.15rem;font-weight:700;margin-top:4px}" +
  ".sv-note{color:var(--muted,#5b6478);font-size:.88rem;border-left:3px solid var(--line,#e3e8f2);padding-left:10px;margin:10px 0}" +
  ".sv-actions{display:flex;flex-wrap:wrap;gap:8px;margin:14px 0 6px}" +
  ".sv-btn{border-radius:999px;border:1px solid var(--accent,#2563eb);background:var(--accent,#2563eb);color:#fff;" +
    "padding:8px 16px;font:inherit;font-weight:600;cursor:pointer}" +
  ".sv-btn.sv-ghost{background:none;color:var(--accent,#2563eb)}" +
  ...
  ".sv-build{margin:12px 0;padding:12px;border:1px dashed var(--line,#e3e8f2);border-radius:12px}" +
  ".sv-slots{display:flex;flex-wrap:wrap;gap:6px;min-height:40px;margin-bottom:10px}" +
  ".sv-slot{border-bottom:2px solid var(--muted,#5b6478);min-width:52px;text-align:center;padding:6px 8px;font-weight:700}" +
  ".sv-tiles{display:flex;flex-wrap:wrap;gap:6px}" +
  ".sv-tile{border-radius:10px;border:1px solid var(--line,#e3e8f2);background:var(--card,#fff);color:var(--ink,#1c2333);padding:7px 12px;font:inherit;font-weight:600;cursor:pointer}" +
  ...
  ".sv-opt{text-align:left;border-radius:10px;border:1px solid var(--line,#e3e8f2);background:var(--card,#fff);color:var(--ink,#1c2333);padding:9px 12px;font:inherit;cursor:pointer}" +
  ...
  ".sv-muted{color:var(--muted,#5b6478);font-size:.85rem}" +
  ".sv-listrow{display:flex;justify-content:space-between;gap:8px;padding:6px 0;border-bottom:1px solid var(--line,#e3e8f2)}" +
  ...
  function openList() {
    ...
    h += "<p style='margin-top:14px'><a class='sv-btn' style='text-decoration:none' href='stem-vocab-hub.html'>Open the STEM Vocab Hub →</a></p>";
    panelBody.innerHTML = h;
    openPanel();
  }
