...
(function () {
  ...
  var SKILLS = {
    ...
    f_squares: { name: "Squares and square roots without a calculator", unit: "found", group: "f_fluency",
      cont: "Maths · Number L7", from: ["f_mult"], needs: null,
    ...
    f_convert: { name: "Convert units — length, time, speed", unit: "found", group: "f_units",
      cont: "Maths · Measurement L7-8", from: ["f_mult"], needs: null,
    ...
    k_table: { name: "Complete a table of values by substitution", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L7-8", from: ["k_coords", "f_mult"], needs: "cp_quiz",
    ...
    k_grad_graph: { name: "Gradient from a graph", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L8", from: ["k_coords"], needs: "cp_quiz",
    ...
    k_grad_pts: { name: "Gradient from two points", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L8-9", from: ["k_grad_graph"], needs: "cp_quiz",
    ...
    k_yint: { name: "The y-intercept, two ways", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L8-9", from: ["k_coords"], needs: "cp_quiz",
    ...
    k_eq: { name: "Equation of a line — y = mx + c", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L8-9", from: ["k_grad_graph", "k_yint"], needs: "cp_quiz",
    ...
    k_sketch: { name: "Sketch a line from its equation", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L8", from: ["k_eq", "k_table"], needs: "cp_quiz",
    ...
    k_intersect: { name: "Point of intersection — from a graph", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L8-9", from: ["k_sketch"], needs: "cp_quiz",
    ...
    k_simult: { name: "Point of intersection — with algebra", unit: "kin", group: "kg_lines",
      cont: "Maths · Algebra L9-10", from: ["k_intersect", "k_eq"], needs: "cp_test",
    ...
    k_parabola: { name: "Read a parabola from its graph", unit: "kin", group: "kg_quad",
      cont: "Maths · Algebra L9-10", from: ["k_yint", "k_sketch"], needs: "cp_test",
    ...
    k_quadeq: { name: "Build the rule y = a(x − h)² + k from the picture", unit: "kin", group: "kg_quad",
      cont: "Maths · Algebra L10", from: ["k_parabola", "k_eq"], needs: "cp_test",
    ...
    k_project: { name: "Model a thrown object with a parabola", unit: "kin", group: "kg_quad",
      cont: "Maths · Algebra L10 · Science · Motion", from: ["k_quadeq", "s_story"], needs: "cp_keg",
    ...
    s_ptgraph: { name: "Read a position-time graph", unit: "kin", group: "kg_motion",
      cont: "Science · Physical L9-10", from: ["k_grad_graph", "s_vectors"], needs: "cp_cat",
    ...
    s_story: { name: "Worded journey ↔ graph", unit: "kin", group: "kg_motion",
      cont: "Science · Physical L9-10 / Maths · Algebra L8", from: ["s_ptgraph"], needs: "cp_cat",
    ...
    s_lobf: { name: "Line of best fit by hand", unit: "kin", group: "kg_data",
      cont: "Maths · Statistics L9", from: ["s_variables", "k_coords"], needs: "cp_report",
    ...
    s_corr: { name: "Describe correlation · r from R²", unit: "kin", group: "kg_data",
      cont: "Maths · Statistics L10", from: ["s_lobf"], needs: "cp_report",
    ...
    s_excel: { name: "Scatterplot, trendline and R² in Excel", unit: "kin", group: "kg_data",
      cont: "Maths · Statistics L9-10 / Science · Inquiry", from: ["s_lobf"], needs: "cp_report",
    ...
    sc_equipment: { name: "Name the equipment and say what it is for", unit: "lab", group: "lg_safe",
      cont: "Science · Science inquiry", from: ["sc_safety"], needs: "cp_bunsen",
    ...
    sc_bunsen: { name: "Light and use a Bunsen burner", unit: "lab", group: "lg_safe",
      cont: "Science · Science inquiry", from: ["sc_equipment"], needs: "cp_bunsen",
    ...
    sc_graph: { name: "Build a line graph that passes TAILS", unit: "lab", group: "lg_data",
      cont: "Science · Science inquiry · Maths · Statistics", from: ["sc_measure", "k_coords"], needs: "cp_graph",
    ...
    sc_trend: { name: "Describe a trend and spot an anomaly", unit: "lab", group: "lg_data",
      cont: "Science · Science inquiry", from: ["sc_graph"], needs: "cp_graph",
    ...
    sc_bonding: { name: "Elements, compounds and the bonds between them", unit: "lab", group: "lg_matter",
      cont: "Science · Chemical sciences", from: ["sc_atom"], needs: "cp_bonding",
    ...
    sc_mixtures: { name: "Mixtures, solutions and solubility", unit: "lab", group: "lg_matter",
      cont: "Science · Chemical sciences", from: ["sc_bonding"], needs: "cp_ph",
    ...
    sc_ph: { name: "Acids, bases and the pH scale", unit: "lab", group: "lg_matter",
      cont: "Science · Chemical sciences", from: ["sc_mixtures", "sc_measure"], needs: "cp_ph",
    ...
    b_genlang: { name: "Genotype and phenotype language", unit: "gen", group: "gg_code",
      cont: "Science · Biological L10", from: ["b_dna"], needs: "cp_traits",
    ...
    b_punnett: { name: "Punnett squares and their ratios", unit: "gen", group: "gg_inherit",
      cont: "Science · Biological L10 / Maths · Probability L9", from: ["b_genlang", "b_samplespace"], needs: "cp_traits",
    ...
    b_pedigree: { name: "Read a pedigree chart", unit: "gen", group: "gg_inherit",
      cont: "Science · Biological L10", from: ["b_punnett"], needs: "cp_biocat",
    ...
    b_samplespace: { name: "Sample spaces and probabilities", unit: "gen", group: "gg_prob",
      cont: "Maths · Probability L7-9", from: ["f_mult"], needs: "cp_biocat",
    ...
    b_tree: { name: "Tree diagrams", unit: "gen", group: "gg_prob",
      cont: "Maths · Probability L9-10", from: ["b_samplespace"], needs: "cp_biocat",
    ...
    p_percent: { name: "Combine percentages correctly", unit: "pan", group: "pg_claims",
      cont: "Maths · Number L8-9", from: ["f_convert"], needs: "cp_pan",
    ...
    p_exp: { name: "Linear vs exponential growth", unit: "pan", group: "pg_claims",
      cont: "Maths · Algebra L10", from: ["p_percent", "k_grad_graph"], needs: "cp_pan",
    ...
    p_claims: { name: "Check a claim against the data", unit: "pan", group: "pg_claims",
      cont: "Science · Inquiry L9-10 / Literacy", from: ["p_percent", "p_exp"], needs: "cp_pan",
  ...
  var MAPS = {
      ...
      stages: [
        ...
        { cols: [
            { words: { sets: ["kin3", "prac"] },
              maths: null,
              science: { skills: ["s_accel", "s_gravity",
                                  "s_variables", "s_lobf", "s_excel", "s_corr"] } }
          ], project: "cp_report" },
        { cols: [
            { words: null, maths: null,
              science: { skills: ["s_vectors", "s_ptgraph", "s_story"] } }
          ], project: "cp_cat" },
        { cols: [
            /* k_parabola/k_quadeq live here because their own `needs` says
               cp_test — the test is where they are examined. The road reads
               cumulatively, so the Keg Toss still "has" them: everything to
               the left of its column feeds it. Nothing appears twice. */
            { words: null,
    ...
    lab: {
      ...
      stages: [
        ...
        { cols: [
            /* lab2 sits here, its first use — the road reads cumulatively,
               so the graph checkpoint two columns right still draws on it */
            { words: { sets: ["lab2"] }, maths: { label: "reading a scale", skills: ["sc_measure"] },
              science: null }
          ], project: "cp_heat" },
        { cols: [
            { words: null, maths: { label: "plotting", skills: ["sc_graph"] },
  ...
  /* ---------------- the skill graph ----------------
     Each skill's `from` lists the skills it builds on — "the turning point
     comes FROM sketching and intercepts". leadsTo() inverts that once, so the
     graph lives in one direction only and can never disagree with itself.
     Cross-unit edges are deliberate: a Lab graph builds on Kinematics
     coordinates, and a page should say so. */
  var LEADS = null;
  function leadsIndex() {
    if (LEADS) return LEADS;
    LEADS = {};
    Object.keys(SKILLS).forEach(function (id) {
      (SKILLS[id].from || []).forEach(function (dep) {
        (LEADS[dep] = LEADS[dep] || []).push(id);
      });
    });
    return LEADS;
  }
  function buildsOn(id) { var sk = SKILLS[id]; return (sk && sk.from) ? sk.from.slice() : []; }
  function leadsTo(id) { return (leadsIndex()[id] || []).slice(); }
